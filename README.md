# Reference FMUs minimal
This is a fork of [Reference FMUs](https://github.com/modelica/Reference-FMUs)
Just for my own convenience to understand how to implement FMUs. ;). I don't care the importers and FMI1.0 so I removed them.
...
- `FMI{1CS|1ME|2|3}.xml` - model descriptions (FMI1.0 support removed from the origin repo, because I don't use it)
